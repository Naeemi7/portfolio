      ...
      <nav className="bg-primary border-gray-200 dark:bg-primary">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            ...
            id="navbar-default"
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-1  rounded-lg bg-primary md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-primary md:dark:bg-primary ">
              <li>
                <a
                  href="#"
